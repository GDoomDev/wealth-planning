          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-1">
                ...
                <DateInput value={formSub.startDate || ''} onChange={val => setFormSub({ ...formSub, startDate: val })} className="w-full p-2 border border-slate-300 rounded-lg bg-white outline-none focus:ring-2 focus:ring-indigo-500" />
              </div>
            </div>
            ...
            <div className="p-4 bg-indigo-50/50 rounded-xl border border-indigo-100 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {!formSub.isIndefinite && (
                <div className="space-y-1 animate-in slide-in-from-right-2">
                  ...
                  <DateInput value={formSub.activeUntil || ''} onChange={val => setFormSub({ ...formSub, activeUntil: val })} className="w-full p-2 border border-indigo-200 rounded-lg bg-white outline-none focus:ring-2 focus:ring-indigo-500" />
                </div>
              )}
            </div>
