                      ...
                      <div className="grid grid-cols-2 gap-4">
                          <div className="col-span-2">
                             ...
                             <div className="relative">
                               ...
                               <input type="date" required className="w-full pl-10 p-2 border border-slate-300 rounded text-sm bg-white" value={createForm.date} onChange={e=>setCreateForm({...createForm, date: e.target.value})}/>
                             </div>
                          </div>
                      </div>
                    ...
                    <div className="space-y-4 animate-in fade-in duration-200">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          ...
                          <input 
                            type="date" 
                            className="w-full pl-8 p-2 border border-slate-200 rounded text-xs bg-white outline-none" 
                            value={editDate} 
