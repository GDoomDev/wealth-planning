        ...
        {showManual ? (
          <form onSubmit={handleManualSubmit} className="bg-slate-50 p-6 rounded-xl border border-indigo-100 space-y-4 animate-in slide-in-from-top-2 duration-300">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <input type="date" className="p-2.5 border border-slate-200 rounded-lg text-sm bg-white" value={manualForm.date} onChange={e=>setManualForm({...manualForm, date: e.target.value})} />
             </div>
